...
# require './lib/songclass.rb'
# require './lib/artistclass.rb'
# require './lib/genreclass.rb'

require_relative 'songclass.rb'
require_relative 'artistclass.rb'
require_relative 'genreclass.rb'
